...
class GeocoderAutoCompleteApiTest(unittest.TestCase):
    ...
    def test_initiation(self):
        ...
        self.assertEqual(self._api._base_url, 'https://autosuggest.search.hereapi.com/v1/autosuggest')

    @responses.activate
    def test_addresssuggestion_whensucceed(self):
        with open('testdata/models/geocoder_autocomplete.json', 'r') as f:
            expectedResponse = f.read()
        responses.add(responses.GET, 'https://autosuggest.search.hereapi.com/v1/autosuggest',
